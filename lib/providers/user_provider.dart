...
import 'package:task2/models/user_model.dart' as usersModel;
import 'package:task2/utils/const.dart';
import 'package:task2/views/home_screen.dart';
import 'package:task2/views/login_screen.dart';
class UserProvider with ChangeNotifier{
  ...
  Future<void> signOut(BuildContext cntxt) async {
    ...
    userID='';
    buildErrorSnackbar(cntxt, 'sign out');
    notifyListeners();
  }
 ...
 loginUser(String userEmail, String userPassword,BuildContext context) async{
      ...
      if (userEmail.isNotEmpty || userPassword.isNotEmpty) {
        ...
        buildErrorSnackbar(context, e.toString());
      }
    onLoading=false;
    notifyListeners();
}
